...
Source0: http://wiki.qemu-project.org/download/qemu-1.1.1.tar.bz2
...
./configure \
    ...
    --interp-prefix="%{buildroot}%{_prefix}/qemu-%%M" \
...
%changelog
* Tue Jul 16 2013 Abel Boldú <abel.boldu@abiquo.com> - 3:1.1.1-2
- qemu-img obsoletes kvm.

* Wed Jun 19 2013 Abel Boldú <abel.boldu@abiquo.com> - 3:1.1.1-1
