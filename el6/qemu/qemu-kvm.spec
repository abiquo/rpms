...
# Abiquo: We define epoch beacuse we pushed a 0.13 package
...
# Obsolete older qemu userspaces
Obsoletes: qemu-common, qemu-system-x86
...
# Epoch because we pushed a qemu-0.13 in abiquo
Epoch: 10
...
%define qemu_ga_build_flags --prefix=%{_prefix} \\\
             ...
             --disable-strip \\\
             --disable-xen \\\
             --block-drv-whitelist=qcow2,raw,file,host_device,host_cdrom,qed,vdi,vmdk,vpc \\\
             --disable-debug-tcg \\\
             --disable-sparse \\\
             --disable-sdl \\\
             --disable-curses \\\
...
# Adding symlink for Abiquo backwards compatibility
ln -s %{_libexecdir}/%{progname} ${RPM_BUILD_ROOT}%{_bindir}/%{progname}
...
%changelog
* Tue May 21 2013 Abel Boldú <abel.boldu@abiquo.com> - 10:0.12.1.2-2.abiquo
- Abiquo customizations. Added symlink for backwards compat

* Wed Feb 06 2013 Michal Novotny <minovotn@redhat.com> - qemu-kvm-0.12.1.2-2.356.el6_4.1
...
* Wed Feb 06 2013 Michal Novotny <minovotn@redhat.com> - qemu-kvm-0.12.1.2-2.356.el6
- kvm-Revert-e1000-no-need-auto-negotiation-if-link-was-do.patch [bz#907397]
- Resolves: bz#907397
  (Patch "e1000: no need auto-negotiation if link was down" may break e1000 guest)
